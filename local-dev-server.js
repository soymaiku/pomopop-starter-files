...
if (missingVars.length > 0) {
  ...
  console.warn('The app will not function without these. Please set them in your .env file.');
}
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/.netlify/functions/firebase-config' || pathname === '/api/firebase-config') {
    const headers = {
