...
export function playYouTubeVideo() {
  ...
  if (urlType === "search") {
    errorMsg.textContent =
      "Search URLs not supported. Please open a video and paste its URL.";
    errorMsg.classList.remove("hidden");
    return;
  }
  ...
  if (urlType === "playlist_only") {
    errorMsg.textContent =
      "Please paste a specific video URL, not a playlist URL.";
    errorMsg.classList.remove("hidden");
    return;
  }
  ...
  if (urlType === "channel") {
    errorMsg.textContent =
      "Channel URLs not supported. Please paste a specific video URL.";
    errorMsg.classList.remove("hidden");
    return;
  }
  ...
  if (!videoId) {
    errorMsg.textContent =
      "Invalid YouTube video URL. Please paste a link like: youtube.com/watch?v=...";
    errorMsg.classList.remove("hidden");
    return;
  }
